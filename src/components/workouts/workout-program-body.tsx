...
export function WorkoutProgramBody({
  ...
  return (
    <>
      ...
      <p className="font-mono text-[11px] font-semibold tracking-wider text-neutral-500 uppercase">
        Programme
      </p>
        ...
        <>
          ...
          >
            <div className="mx-auto flex max-w-3xl flex-col gap-1.5">
              <ButtonLink
                href={`/workouts/${templateId}/session?exercise=${(resumeExercise ?? exercises[0]).exerciseId}`}
                size="lg"
